...
function outputIm=mini_imagesProcessor(inputIm_Previous,inputIm,enhancement_multiplier,LP_filter_PS,N_smoothing,Erosion_se,N_erosion,Dilution_se,N_dilution,LP_filter_Hand)


[inputIm_Enhanced,PenStrokes_Mask] =mini_imageEnhancer(inputIm,enhancement_multiplier,LP_filter_PS,N_smoothing,Erosion_se,N_erosion,Dilution_se,N_dilution);
